...
def create_data_dictionary(df: pd.DataFrame, val_results: Dict[str, Any]) -> pd.DataFrame:
    ...
    dict_rows = [
        ...
        {"Variable": "DXY", "Source": "FRED / Yahoo Finance", "Series_ID": "DTWEXBGS / DX-Y.NYB", "Frequency": "Daily", "Transformation": "Monthly arithmetic mean", "Units": "Index", "First_Valid_Date": val_results['missing_summary']['DXY']['first_valid_date'], "Last_Valid_Date": val_results['missing_summary']['DXY']['last_valid_date'], "Missing_Count": val_results['missing_summary']['DXY']['missing_count']},
    ]
