...
def main():
    print("=" * 80)
    print("GeoPrice Production Model Retraining Script")
    print("=" * 80)
    ...
    print("\nTraining and exporting production models for 5 commodities...")
    ...
    for c in COMMODITIES:
        ...
        pipeline = build_baseline_pipeline(alpha=0.01, l1_ratio=0.5)
        ...
        print(f"  -> {c:15s} | Saved to '{model_path}' ({len(dataset)} samples, {train_start} to {train_end})")
